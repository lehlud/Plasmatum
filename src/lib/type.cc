...
inline std::function<plsm_size_t(Engine *)> getBinExprFunction(
  ...
  return [=](Engine *engine) {
    std::shared_ptr<Value> v2 = engine->stackPop();
    std::shared_ptr<Value> v1 = engine->stackPop();
...
void Type::setupFloatType(std::shared_ptr<Type> intType,
  ...
  tmpInst = getCustomBinExprInst(
      [](std::shared_ptr<Value> v1, std::shared_ptr<Value> v2) {
        return (std::shared_ptr<Value>)FloatValue::get(v1->asFloat() +
                                                       v2->asFloat());
      });
  ...
  tmpInst = getCustomBinExprInst(
      [](std::shared_ptr<Value> v1, std::shared_ptr<Value> v2) {
        return (std::shared_ptr<Value>)FloatValue::get(
            v2->asBoolean() ? v1->asFloat() : 0);
      });
...
void Type::setupIntegerType(std::shared_ptr<Type> intType,
  ...
  tmpInst = getCustomBinExprInst(
      [](std::shared_ptr<Value> v1, std::shared_ptr<Value> v2) {
        return (std::shared_ptr<Value>)IntegerValue::get(v1->asInteger() +
                                                         v2->asInteger());
      });
  ...
  tmpInst = getCustomBinExprInst(
      [](std::shared_ptr<Value> v1, std::shared_ptr<Value> v2) {
        return (std::shared_ptr<Value>)FloatValue::get(v1->asInteger() -
                                                       v2->asFloat());
      });
  ...
  tmpInst = getCustomBinExprInst(
      [](std::shared_ptr<Value> v1, std::shared_ptr<Value> v2) {
        return (std::shared_ptr<Value>)IntegerValue::get(
            v2->asBoolean() ? v1->asInteger() : 0);
      });
